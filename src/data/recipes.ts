...
export const recipes: Recipe[] = [
  {
    ...
    ingredients: [
      { amount: 1.5, unit: "kg", name: { en: "beef short rib, bone-in", es: "costilla de res con hueso", pt: "costela bovina com osso" }, shopQuery: "beef short ribs" },
      ...
      { amount: 4, unit: "piece", name: { en: "dried guajillo chiles", es: "chiles guajillo secos", pt: "pimentas guajillo secas" }, shopQuery: "dried guajillo chiles" },
      { amount: 1, unit: "piece", name: { en: "dried kombu (kelp)", es: "kombu seco", pt: "kombu seco" }, shopQuery: "dried kombu" },
      { amount: 500, unit: "ml", name: { en: "dark beef stock", es: "caldo oscuro de res", pt: "caldo escuro de carne" }, shopQuery: "beef broth" },
      { amount: 2, unit: "tbsp", name: { en: "agave nectar", es: "néctar de agave", pt: "néctar de agave" }, shopQuery: "agave nectar" },
      ...
      { amount: 1, unit: "piece", name: { en: "red onion", es: "cebolla morada", pt: "cebola roxa" }, shopQuery: "red onion" },
  ...
  },
  {
    ...
    ingredients: [
      { amount: 4, unit: "piece", name: { en: "sweet corn on the cob", es: "elotes", pt: "espigas de milho" }, shopQuery: "corn on the cob" },
      { amount: 100, unit: "g", name: { en: "napa kimchi", es: "kimchi de col napa", pt: "kimchi de acelga" }, allergens: ["soy"], shopQuery: "napa cabbage kimchi" },
      { amount: 4, unit: "tbsp", name: { en: "sour cream", es: "crema ácida", pt: "creme azedo" }, allergens: ["dairy"], shopQuery: "sour cream" },
      { amount: 2, unit: "tbsp", name: { en: "mayonnaise", es: "mayonesa", pt: "maionese" }, allergens: ["egg"], shopQuery: "mayonnaise" },
      { amount: 1, unit: "tsp", name: { en: "gochugaru (Korean chile flakes)", es: "gochugaru (chile coreano en escamas)", pt: "gochugaru (pimenta coreana em flocos)" }, shopQuery: "gochugaru" },
      { amount: 50, unit: "g", name: { en: "queso fresco", es: "queso fresco", pt: "queijo fresco" }, allergens: ["dairy"], shopQuery: "queso fresco" },
      { amount: 1, unit: "piece", name: { en: "lime", es: "lima", pt: "lima" }, shopQuery: "lime" },
  ...
  },
  {
    ...
    ingredients: [
      { amount: 200, unit: "g", name: { en: "fresh yellowtail (hamachi)", es: "hamachi fresco", pt: "hamachi fresco" }, allergens: ["fish"], shopQuery: "yellowtail hamachi" },
      { amount: 4, unit: "tbsp", name: { en: "yuzu juice", es: "jugo de yuzu", pt: "suco de yuzu" }, shopQuery: "yuzu juice" },
      { amount: 2, unit: "tbsp", name: { en: "lime juice", es: "jugo de lima", pt: "suco de lima" }, shopQuery: "lime juice" },
      { amount: 1, unit: "piece", name: { en: "serrano chile", es: "chile serrano", pt: "pimenta serrano" }, shopQuery: "serrano pepper" },
      { amount: 1, unit: "tsp", name: { en: "soy sauce", es: "salsa de soja", pt: "molho de soja" }, allergens: ["soy", "gluten"], shopQuery: "soy sauce" },
      { amount: 1, unit: "piece", name: { en: "cucumber", es: "pepino", pt: "pepino" }, shopQuery: "cucumber" },
      { amount: 1, unit: "tbsp", name: { en: "olive oil", es: "aceite de oliva", pt: "azeite de oliva" }, shopQuery: "olive oil" },
  ...
  },
  {
    ...
    ingredients: [
      { amount: 700, unit: "g", name: { en: "pork shoulder", es: "lomo de cerdo", pt: "paleta suína" }, allergens: ["pork"], shopQuery: "pork shoulder" },
      { amount: 3, unit: "piece", name: { en: "dried guajillo chiles", es: "chiles guajillo secos", pt: "pimentas guajillo secas" }, shopQuery: "dried guajillo chiles" },
      { amount: 2, unit: "piece", name: { en: "dried ancho chiles", es: "chiles ancho secos", pt: "pimentas ancho secas" }, shopQuery: "dried ancho chiles" },
      { amount: 1, unit: "tbsp", name: { en: "achiote paste", es: "pasta de achiote", pt: "pasta de achiote" }, shopQuery: "achiote paste" },
      { amount: 2, unit: "tbsp", name: { en: "white vinegar", es: "vinagre blanco", pt: "vinagre branco" }, shopQuery: "white vinegar" },
      { amount: 200, unit: "g", name: { en: "fresh pineapple", es: "piña fresca", pt: "abacaxi fresco" }, shopQuery: "fresh pineapple" },
      { amount: 1, unit: "tsp", name: { en: "five-spice powder", es: "polvo cinco especias", pt: "pó de cinco especiarias" }, shopQuery: "five-spice powder" },
      { amount: 1, unit: "tbsp", name: { en: "soy sauce", es: "salsa de soja", pt: "molho shoyu" }, allergens: ["soy", "gluten"], shopQuery: "soy sauce" },
      { amount: 12, unit: "piece", name: { en: "bao buns (frozen)", es: "panes bao (congelados)", pt: "pães bao (congelados)" }, allergens: ["gluten", "dairy"], shopQuery: "frozen bao buns" },
  ...
  },
  {
    ...
    ingredients: [
      { amount: 1.5, unit: "kg", name: { en: "pork bones (neck + trotters)", es: "huesos de cerdo (cuello + patitas)", pt: "ossos suínos (pescoço + mocotó)" }, allergens: ["pork"], shopQuery: "pork neck bones" },
      { amount: 1, unit: "piece", name: { en: "onion", es: "cebolla", pt: "cebola" }, shopQuery: "yellow onion" },
      { amount: 1, unit: "piece", name: { en: "garlic head", es: "cabeza de ajo", pt: "cabeça de alho" }, shopQuery: "garlic" },
      { amount: 1, unit: "piece", name: { en: "dried kombu (kelp)", es: "kombu seco", pt: "kombu seco" }, shopQuery: "dried kombu" },
      { amount: 3, unit: "piece", name: { en: "dried guajillo chiles", es: "chiles guajillo secos", pt: "pimentas guajillo secas" }, shopQuery: "dried guajillo chiles" },
      { amount: 2, unit: "piece", name: { en: "dried chile de árbol", es: "chiles de árbol secos", pt: "pimentas de árbol secas" }, shopQuery: "chile de arbol" },
      { amount: 60, unit: "ml", name: { en: "neutral oil (vegetable)", es: "aceite neutro (vegetal)", pt: "óleo neutro (vegetal)" }, shopQuery: "vegetable oil" },
      { amount: 400, unit: "g", name: { en: "canned white hominy", es: "maíz pozolero enlatado", pt: "milho pozole em lata" }, shopQuery: "canned white hominy" },
      { amount: 320, unit: "g", name: { en: "ramen noodles (fresh or dried)", es: "fideos ramen (frescos o secos)", pt: "macarrão ramen (fresco ou seco)" }, allergens: ["gluten", "egg"], shopQuery: "ramen noodles" },
      { amount: 4, unit: "piece", name: { en: "eggs", es: "huevos", pt: "ovos" }, allergens: ["egg"], shopQuery: "eggs" },
  ...
  },
  {
    ...
    ingredients: [
      { amount: 100, unit: "g", name: { en: "popcorn kernels", es: "granos de palomitas", pt: "milho de pipoca" }, shopQuery: "popcorn kernels" },
      { amount: 2, unit: "tbsp", name: { en: "neutral oil (vegetable)", es: "aceite neutro (vegetal)", pt: "óleo neutro (vegetal)" }, shopQuery: "vegetable oil" },
      { amount: 3, unit: "tbsp", name: { en: "butter", es: "mantequilla", pt: "manteiga" }, allergens: ["dairy"], shopQuery: "butter" },
      { amount: 2, unit: "tbsp", name: { en: "chamoy syrup", es: "jarabe de chamoy", pt: "calda de chamoy" }, shopQuery: "chamoy syrup" },
      { amount: 2, unit: "tbsp", name: { en: "furikake", es: "furikake", pt: "furikake" }, allergens: ["sesame", "fish"], shopQuery: "furikake seasoning" },
      { amount: 1, unit: "tsp", name: { en: "Tajín chile-lime seasoning", es: "Tajín chile-lima", pt: "Tajín chile-lima" }, shopQuery: "Tajin seasoning" },
    ],
    method: {
      en: [
  ...
  },
  {
    ...
    ingredients: [
      { amount: 180, unit: "g", name: { en: "sugar", es: "azúcar", pt: "açúcar" }, shopQuery: "sugar" },
      { amount: 1, unit: "tsp", name: { en: "mezcal", es: "mezcal", pt: "mezcal" }, allergens: ["alcohol"], shopQuery: "mezcal" },
      { amount: 500, unit: "ml", name: { en: "whole milk", es: "leche entera", pt: "leite integral" }, allergens: ["dairy"], shopQuery: "whole milk" },
      { amount: 200, unit: "ml", name: { en: "sweetened condensed milk", es: "leche condensada", pt: "leite condensado" }, allergens: ["dairy"], shopQuery: "sweetened condensed milk" },
      { amount: 2, unit: "tbsp", name: { en: "white miso paste", es: "pasta de miso blanco", pt: "pasta de missô branco" }, allergens: ["soy"], shopQuery: "white miso" },
      { amount: 7, unit: "piece", name: { en: "eggs (5 whole + 2 yolks)", es: "huevos (5 enteros + 2 yemas)", pt: "ovos (5 inteiros + 2 gemas)" }, allergens: ["egg"], shopQuery: "eggs" },
      { amount: 1, unit: "piece", name: { en: "vanilla bean (or 1 tsp extract)", es: "vaina de vainilla (o 1 cdta de extracto)", pt: "fava de baunilha (ou 1 cc de extrato)" }, shopQuery: "vanilla" },
  ...
  },
  {
    ...
    ingredients: [
      { amount: 1, unit: "kg", name: { en: "chicken wings", es: "alitas de pollo", pt: "asinhas de frango" }, shopQuery: "chicken wings" },
      { amount: 1, unit: "tsp", name: { en: "baking powder", es: "polvo para hornear", pt: "fermento químico" }, shopQuery: "baking powder" },
      { amount: 1, unit: "tsp", name: { en: "salt", es: "sal", pt: "sal" }, shopQuery: "salt" },
      { amount: 3, unit: "tbsp", name: { en: "tamarind concentrate", es: "concentrado de tamarindo", pt: "concentrado de tamarindo" }, shopQuery: "tamarind concentrate" },
      { amount: 3, unit: "tbsp", name: { en: "soy sauce", es: "salsa de soja", pt: "molho shoyu" }, allergens: ["soy", "gluten"], shopQuery: "soy sauce" },
      { amount: 3, unit: "tbsp", name: { en: "brown sugar", es: "azúcar moreno", pt: "açúcar mascavo" }, shopQuery: "brown sugar" },
      { amount: 1, unit: "piece", name: { en: "Fresno chile", es: "chile Fresno", pt: "pimenta Fresno" }, shopQuery: "Fresno pepper" },
      { amount: 2, unit: "piece", name: { en: "garlic cloves", es: "dientes de ajo", pt: "dentes de alho" }, shopQuery: "garlic" },
  ...
  },
  {
    ...
    ingredients: [
      { amount: 5, unit: "piece", name: { en: "eggs", es: "huevos", pt: "ovos" }, allergens: ["egg"], shopQuery: "eggs" },
      { amount: 200, unit: "g", name: { en: "sugar", es: "azúcar", pt: "açúcar" }, shopQuery: "sugar" },
      { amount: 180, unit: "g", name: { en: "cake flour", es: "harina para repostería", pt: "farinha de bolo" }, allergens: ["gluten"], shopQuery: "cake flour" },
      { amount: 1, unit: "tsp", name: { en: "ground cinnamon", es: "canela molida", pt: "canela em pó" }, shopQuery: "ground cinnamon" },
      { amount: 300, unit: "ml", name: { en: "horchata (Mexican rice drink)", es: "horchata (bebida de arroz)", pt: "horchata (bebida de arroz)" }, shopQuery: "horchata" },
      { amount: 200, unit: "ml", name: { en: "evaporated milk", es: "leche evaporada", pt: "leite evaporado" }, allergens: ["dairy"], shopQuery: "evaporated milk" },
      { amount: 200, unit: "ml", name: { en: "sweetened condensed milk", es: "leche condensada", pt: "leite condensado" }, allergens: ["dairy"], shopQuery: "sweetened condensed milk" },
      { amount: 300, unit: "ml", name: { en: "heavy cream (for whipping)", es: "crema para batir", pt: "creme de leite para bater" }, allergens: ["dairy"], shopQuery: "heavy cream" },
      { amount: 2, unit: "tsp", name: { en: "matcha powder", es: "matcha en polvo", pt: "matcha em pó" }, shopQuery: "matcha powder" },
    ],
    method: {
      en: [
