...
export const recipes: Recipe[] = [
  {
    ...
    hero: recipeHero("miso-mole-short-rib-tacos", 1800, 1100),
    thumb: recipeHero("miso-mole-short-rib-tacos", 900, 700),
    prepMinutes: 30,
    cookMinutes: 720,
    serves: 4,
    difficulty: "hard",
  ...
  },
  {
    ...
    hero: recipeHero("kimchi-elote", 1800, 1100),
    thumb: recipeHero("kimchi-elote", 900, 700),
    prepMinutes: 10,
    cookMinutes: 12,
    serves: 4,
    difficulty: "easy",
  ...
  },
  {
    ...
    hero: recipeHero("yuzu-aguachile-hamachi", 1800, 1100),
    thumb: recipeHero("yuzu-aguachile-hamachi", 900, 700),
    prepMinutes: 25,
    cookMinutes: 0,
    serves: 2,
    difficulty: "medium",
  ...
  },
  {
    ...
    hero: recipeHero("al-pastor-bao", 1800, 1100),
    thumb: recipeHero("al-pastor-bao", 900, 700),
    prepMinutes: 40,
    cookMinutes: 30,
    serves: 6,
    difficulty: "medium",
  ...
  },
  {
    ...
    hero: recipeHero("ramen-pozole-rojo", 1800, 1100),
    thumb: recipeHero("ramen-pozole-rojo", 900, 700),
    prepMinutes: 20,
    cookMinutes: 90,
    serves: 4,
    difficulty: "medium",
  ...
  },
  {
    ...
    hero: recipeHero("chamoy-furikake-popcorn", 1800, 1100),
    thumb: recipeHero("chamoy-furikake-popcorn", 900, 700),
    prepMinutes: 3,
    cookMinutes: 5,
    serves: 4,
    difficulty: "easy",
  ...
  },
  {
    ...
    hero: recipeHero("miso-mezcal-flan", 1800, 1100),
    thumb: recipeHero("miso-mezcal-flan", 900, 700),
    prepMinutes: 20,
    cookMinutes: 50,
    serves: 6,
    difficulty: "medium",
  ...
  },
  {
    ...
    hero: recipeHero("tamarindo-shoyu-glazed-wings", 1800, 1100),
    thumb: recipeHero("tamarindo-shoyu-glazed-wings", 900, 700),
    prepMinutes: 15,
    cookMinutes: 45,
    serves: 4,
    difficulty: "easy",
  ...
  },
  {
    ...
    hero: recipeHero("horchata-tres-leches-matcha", 1800, 1100),
    thumb: recipeHero("horchata-tres-leches-matcha", 900, 700),
    prepMinutes: 25,
    cookMinutes: 30,
    serves: 8,
    difficulty: "medium",
